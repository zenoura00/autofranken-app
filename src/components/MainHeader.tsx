      ...
      <div className="bg-white dark:bg-gray-900 border-b dark:border-gray-800">
        <div className="container mx-auto px-4 py-2 flex justify-center items-center">
          <div className="flex gap-4 items-center">
            <a href="mailto:info@moebelmontage-nuernberg.de" className="p-2 rounded-full hover:bg-emerald-50 dark:hover:bg-gray-800 transition-all hover:scale-110" title="E-Mail senden">
            ...
            >
              <div className="rounded-lg p-1 md:p-2">
                <Image
                  ...
                  alt="Möbelmontage Nürnberg Logo"
                  width={240}
                  height={80}
                  priority
